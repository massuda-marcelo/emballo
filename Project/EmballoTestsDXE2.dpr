...
uses
  ...
  Emballo.DI.FactoryMethodTests in '..\Tests\Emballo.DI.FactoryMethodTests.pas',
  Emballo.DI.FactoryMethodBindingTests in '..\Tests\Emballo.DI.FactoryMethodBindingTests.pas';
